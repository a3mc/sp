...
const box2 = grid.set(3, 0, 3, 3, blessed_1.default.list, {
...
const bar = grid.set(6, 0, 4, 3, blessed_contrib_1.default.bar, { label: ' Server (96/512GB) % ',
    barBgColor: 'green',
    barWidth: 10,
    barSpacing: 14,
    xOffset: 4,
    maxHeight: 100 });
bar.setData({ titles: ['CPU (all)', 'Memory'],
    data: [12.2, 3.4] });
const line = grid.set(0, 3, 3, 4, blessed_contrib_1.default.line, { style: { line: "yellow",
        text: "green",
        baseline: "black" },
    xLabelPadding: 3,
    xPadding: 5,
...
const line2 = grid.set(3, 3, 3, 4, blessed_contrib_1.default.line, { style: { line: "yellow",
        text: "green",
        baseline: "black" },
    xLabelPadding: 3,
    xPadding: 5,
...
const log = grid.set(0, 7, 3, 5, blessed_contrib_1.default.log, { fg: "green",
    selectedFg: "green",
    tags: true,
